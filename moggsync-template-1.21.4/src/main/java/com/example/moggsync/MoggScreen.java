...
public class MoggScreen extends Screen {
    private static final int W = 400, H = 300, ROW = 25;
    ...
    private void buildLobby(int y) {
        ...
        field(y, "Пауза перед кликом, мс", String.valueOf(cfg.menuClickDelayMs), 5, true,
                s -> cfg.menuClickDelayMs = parse(s, cfg.menuClickDelayMs, 0)); y += ROW;
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawText(textRenderer, "Сейчас: " + mod.timerText(), left + 16, top + H - 42, TEXT, false);
